...
for VARIANT in $VARIANTS; do
  ...
  wget --no-clobber https://git.inf.bi.ruhr-uni-bochum.de/iib_pub/BeamerThemeIIB/-/raw/master/fonts/truetype/rub/rubflama/${VARIANT}.ttf -O "${DEST_DIR}/${VARIANT}.ttf" --no-check-certificate
done
